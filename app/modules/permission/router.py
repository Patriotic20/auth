...
@router.post("/", response_model=PermissionCreateResponse, status_code=status.HTTP_201_CREATED)
...
async def update_permission(
    ...
    return await get_permission_repository.update_permission(session=session, permission_id=permission_id, data=data)
